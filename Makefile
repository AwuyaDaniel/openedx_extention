...
extract_translations: ## extract strings to be translated, outputting .mo files
	rm -rf docs/_build
	cd openedx_extention && ../manage.py makemessages -l en -v1 -d django
	cd openedx_extention && ../manage.py makemessages -l en -v1 -d djangojs

compile_translations: ## compile translation files, outputting .po files for each supported language
	cd openedx_extention && ../manage.py compilemessages

detect_changed_source_translations:
	cd openedx_extention && i18n_tool changed
...
dummy_translations: ## generate dummy translation (.po) files
	cd openedx_extention && i18n_tool dummy
