#!/usr/bin/env python
"""
Package metadata for openedx_extention.
"""
import os
import re
import sys
...
VERSION = get_version('openedx_extention', '__init__.py')
...
setup(
    ...
    url='https://github.com/openedx/Openedx_extention',
    packages=find_packages(
        include=['openedx_extention', 'openedx_extention.*'],
        exclude=["*tests"],
    ),
    entry_points={
        "lms.djangoapp": [
