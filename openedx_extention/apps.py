"""
openedx_extention Django application initialization.
"""

from django.apps import from django.apps import AppConfig
    ...
    plugin_app = {
        ...
        PluginURLs.CONFIG: {
            ...
            'lms.djangoapp': {
                ...
                PluginURLs.NAMESPACE: 'openedx_extention',

                # The application namespace to provide to django's urls.include.
                # Optional; Defaults to None.
                PluginURLs.APP_NAME: 'openedx_extention',

                # The regex to provide to django's urls.url.
                # Optional; Defaults to r''.
                PluginURLs.REGEX: r'^api/openedx_extention/',
