...
"""
Openedx_extention documentation build configuration file.
...
html_context = {
    ...
    "github_repo": 'Openedx_extention',  # Repo name
...
#
html_theme_options = {
    "repository_url": "https://github.com/openedx/Openedx_extention",
...
#
# html_title = 'Openedx_extention v0.1.0'
...
def on_init(app):  # pylint: disable=unused-argument
    ...
    check_call([apidoc_path, '-o', docs_path, os.path.join(root_path, 'openedx_extention'),
                os.path.join(root_path, 'openedx_extention/migrations')])
